...
export default class NavatarResearchComboboxWithSearchLwc extends LightningElement {
    ...
    toggle() {
        //Added searchBox by LK on 2024-06-19 to fix 00039650
        const searchBox = this.template.querySelector('.slds-combobox__input');
        searchBox.blur();
        this.showList = false;
    }
  ...
  */
    ...
    renderedCallback(){
        ...
        //00045308 fixed by raju on dated 30-05-2024
        style.innerText = `.clsLableHidden .slds-no-flex
        {
            display: none
        }
        `;
