...
import fetchLookupData from '@salesforce/apex/NavatarComboboxCtrl.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/NavatarComboboxCtrl.fetchDefaultRecord';

const DELAY = 300; // dealy apex callout timing in miliseconds  

export default class NavatarAcuityAddToThemeLWC extends LightningElement {
  ...
  // update searchKey property on input field change  
   ...
   handleRemove(){
    this.searchKey = '';    
    this.selectedRecord = {};
    this.lookupUpdatehandler(this.searchKey); // update value on parent component as well from helper function 
