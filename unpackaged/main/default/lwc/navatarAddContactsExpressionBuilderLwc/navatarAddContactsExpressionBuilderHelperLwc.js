   ...
   //alert('Field Type-->'+fieldType);
    ...
    if (fieldType != '') {
        switch (fieldType) {
            case "MULTIPICKLIST":
                options = [
                    { label: "equals", value: "IN:" },  // bug #00040884 fixes added by salauddin sheikh
                    { label: "not equal to", value: "NOT IN:" }, // bug #00040884 fixes added by salauddin sheikh
            ...
            case "PICKLIST":
                    ...
                    options = [{ label: "equals", value: "IN:" }, // bug #00040884 fixes added by salauddin sheikh
                    { label: "not equal to", value: "NOT IN:" }, // bug #00040884 fixes added by salauddin sheikh
                    { label: "less than", value: "<" },
                    { label: "greater than", value: ">" },
                    { label: "less or equal", value: "<=" },
