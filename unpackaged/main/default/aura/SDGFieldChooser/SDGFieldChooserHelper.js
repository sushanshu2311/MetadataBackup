...
({
    ...
    HidePicker: function(cmp) {
        ...
        if(cmp.get("v.calledFromSdg")){
            //this parameter is used to tell parent component to act accordingly
            cmp.set('v.pickerHidden',true);
